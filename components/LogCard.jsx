...
export default function LogCard() {
    return (
        <div className="w-full p-3 bg-white flex flex-col gap-3 rounded-md">
            ...
            <Link
                href="/singup"
                className="text-center whitespace-nowrap rounded-lg border border-blue-600 p-2 font-semibold hover:bg-blue-600 hover:text-white hover:underline text-blue-600"
            >
                Create account
            </Link>
            <Link
